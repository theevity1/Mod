...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'shoplist':
				dialogue = CoolUtil.coolTextFile(Paths.txt('shoplist/shoplistDialogue'));
		}
		...
		switch(SONG.stage)
		{
			...
			{	
				defaultCamZoom = 0.9;
				curStage = 'shoplist';
				var bg:FlxSprite = new FlxSprite(-360, -380);
				bg.loadGraphic(Paths.image('troublestuff/Mall_BG_Back'));
				bg.antialiasing = true;
				...
				var ppl:FlxSprite = new FlxSprite(240, 120);
				ppl.frames = Paths.getSparrowAtlas("troublestuff/CrowdMall");
				ppl.animation.addByPrefix("vibe", "Bounce 1 instance", 24, true); 
				ppl.animation.play("vibe");
				ppl.setGraphicSize(Std.int(bg.width * 0.62));
				add(ppl);

				bg2 = new FlxSprite(-360, -190);
				bg2.loadGraphic(Paths.image('troublestuff/Mall_BG_Front'));
				bg2.antialiasing = true;
				bg2.scrollFactor.set(0.8, 0.8);
				bg2.setGraphicSize(Std.int(bg2.width * 1.35));
				bg2.updateHitbox();
